...
class CalculadoraCientifica:  # Corrección aquí: 'CAlculadoraCientifica' => 'CalculadoraCientifica'
    def __init__(self):
    ...
    def sumar(self, a, b):
        ...
        logger.info(f"Sumando {a} + {b}")  # Uso de f-string para formatear la cadena
        return a + b
...
def main():
    ...
    calc = CalculadoraCientifica()  # Corrección: 'CalculadoraCientifica' con C mayúscula
